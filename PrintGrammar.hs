...
instance Print TopDef where
  prt i e = case e of
    FnDecl type_ id args block -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
    VarDecl type_ items -> prPrec i 0 (concatD [prt 0 type_, prt 0 items, doc (showString ";")])
    ConstDecl type_ items -> prPrec i 0 (concatD [doc (showString "const"), prt 0 type_, prt 0 items, doc (showString ";")])
...
instance Print Stmt where
  prt i e = case e of
    ...
    ElseCond expr stmt1 stmt2 -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 stmt1, doc (showString "else"), prt 0 stmt2])
    While expr stmt -> prPrec i 0 (concatD [doc (showString "while"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 stmt])
    For id expr1 expr2 stmt -> prPrec i 0 (concatD [doc (showString "for"), doc (showString "("), prt 0 id, doc (showString "="), prt 0 expr1, doc (showString "to"), prt 0 expr2, doc (showString ")"), prt 0 stmt])
    ...
    StmtExp expr -> prPrec i 0 (concatD [prt 0 expr, doc (showString ";")])
    StmtDecl topdef -> prPrec i 0 (concatD [prt 0 topdef])
  prtList _ [] = (concatD [])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
...
instance Print Expr where
  prt i e = case e of
    ...
    Neg expr -> prPrec i 6 (concatD [doc (showString "-"), prt 6 expr])
    Not expr -> prPrec i 6 (concatD [doc (showString "!"), prt 6 expr])
